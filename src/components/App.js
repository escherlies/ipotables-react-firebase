      ...
      <BrowserRouter>
        <div className="App" >
          ...
          <div style={{ padding: 15, maxWidth: 768, margin: 'auto' }}>
            ...
            <Switch>
              <Route exact path='/modules/add-new-module/:moduleTitle' render={({ match, history }) => <IpoModule newModule={true} things={things} goBack={() => history.push('/modules')} module={{ title: match.params.moduleTitle }} history={history} />} />
              <Route exact path='/modules/add-new-module' render={({ history }) => <IpoModule newModule={true} things={things} goBack={() => history.push('/modules')} history={history} />} />
              ...
              <Route exact path='/modules/:moduleKey' render={({ match, history }) => <IpoModule moduleKey={match.params.moduleKey} things={things} readOnly={true} module={_.get(modules, match.params.moduleKey)} goBack={() => history.push('/modules')} navigateToModule={() => history.push(`/modules/${match.params.moduleKey}/edit`)} />} />
            </Switch>
          </div>
